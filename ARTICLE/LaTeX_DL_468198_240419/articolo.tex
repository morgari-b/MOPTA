...
\begin{observation}
  Under the hypothesis of the previous proposition, if  \((\rowP, \colP)\) is an equal weight aggregation, then the cost of the aggregated problem 
  is equal to the cost of the unaggregated problem. \gr[]{can we generalize this?}
\end{observation}
