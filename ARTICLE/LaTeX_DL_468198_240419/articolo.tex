...
Our model describes a network in Europe that is to be powered and supplied of hydrogen trough power generated 
...
\textcolor{red}{Correggere: Rows and columns are combined via equal-weight aggregation}. This aggregation maintains the structure of the original problem, 
